...
function createIframe(
    ...
    if (typeof containerDomObj != "object") return false;
    if (typeof id != "string") return false;
    if (typeof bodyContent != "string") var bodyContent = "";
    if (typeof headContent != "string") var headContent = "";
    if (typeof width != "string") var width = "100%";
    if (typeof height != "string") var height = "100%";
    try {
        ...
        jQuery(iframeObj).attr(
            "style",
            "border:0;padding:0;margin:0;width:" + width + ";height:" + height
        );
